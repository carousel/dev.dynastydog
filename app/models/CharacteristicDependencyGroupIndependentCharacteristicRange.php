...
class CharacteristicDependencyGroupIndependentCharacteristicRange extends Eloquent {

    public $table = 'characteristic_dependency_group_ind_characteristic_ranges';
