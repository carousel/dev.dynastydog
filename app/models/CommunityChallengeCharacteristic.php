...
class CommunityChallengeCharacteristic extends Eloquent {
    ...
    */
    ...
    {
        return $query->select('community_challenge_characteristics.*')
            ->leftJoin('characteristics', 'characteristics.id', '=', 'community_challenge_characteristics.characteristic_id')
    ...
    */
    ...
    {
        return $this->belongsToMany('Genotype', 'community_challenge_characteristic_genotypes', 'community_challenge_characteristic_id', 'genotype_id');
    }
    ...
    {
        return $this->belongsToMany('Phenotype', 'community_challenge_characteristic_phenotypes', 'community_challenge_characteristic_id', 'phenotype_id');
    }
    ...
    */
    ...
    public function getRangedBounds()
    {
        ...
        $acceptance = Config::get('game.community_challenge.acceptance_range');
