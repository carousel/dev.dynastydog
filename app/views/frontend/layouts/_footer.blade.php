        ...
        @section('js_assets')
            ...
            <script type="text/javascript" src="{{ asset('assets/js/site.js') }}?2015010902"></script>
        @show
        ...
        @section('modals')
            <!-- Chat Turns Modal -->
            @include('frontend/modals/chat_turns')
            
            <!-- Advanced Turn Modal -->
            @include('frontend/modals/advanced_turn')

            <!-- Tutorial Modal -->
            @include('frontend/modals/tutorial')
        @show
    </body>
</html>
